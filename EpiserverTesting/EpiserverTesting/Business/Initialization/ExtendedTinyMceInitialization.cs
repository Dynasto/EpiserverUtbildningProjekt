using EpiserverTesting.Models.Blocks;
using EpiserverTesting.Models.Pages;
using EPiServer.Cms.TinyMce.Core;
using EPiServer.Framework;
using EPiServer.Framework.Initialization;
using EPiServer.ServiceLocation;
using EpiserverTesting.Business.ExtensionMethods;

namespace EpiserverTesting.Business.Initialization
{
    ...
    public class ExtendedTinyMceInitialization : IConfigurableModule
    {
        ...
        public void ConfigureContainer(ServiceConfigurationContext context)
        {
            context.Services.Configure<TinyMceConfiguration>(config =>
            {
                ...
                .AddPlugin("code")
                .AppendToolbar("code")
                //.InsertToolAfter("styleselect", "formatselect")

                .StyleFormats(new { 
                    title = "hejsan svejsan text", selector ="ol", classes= "hejsansvejsannumbering"
                })
