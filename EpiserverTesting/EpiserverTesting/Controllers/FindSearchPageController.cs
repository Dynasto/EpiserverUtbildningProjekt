...
using EpiserverTesting.Controllers;
using EPiServer.Web;
...
namespace EpiserverTesting.Controllers
{
    public class FindSearchPageController : PageControllerBase<FindSearchPage>
    {
        ...
        public FindSearchPageController(IClient searchClient, IFindUIConfiguration findUIConfiguration,
            IRequiredClientResourceList requiredClientResourceList, IVirtualPathResolver virtualPathResolver)
        {
