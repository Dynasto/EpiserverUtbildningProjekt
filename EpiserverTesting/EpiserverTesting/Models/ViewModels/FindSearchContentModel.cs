...
namespace EpiserverTesting.Models.ViewModels
{
    public class FindSearchContentModel : PageViewModel<FindSearchPage>
    {
        ...
        {
            return UriUtil.AddQueryString(HttpContext.Current.Request.RawUrl, "p", ((PagingSection * PagingSectionSize) + 1).ToString());
        }
