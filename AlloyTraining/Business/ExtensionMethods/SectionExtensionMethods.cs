...
namespace AlloyTraining.Business.ExtensionMethods
{
    public static class SectionExtensionMethods
    {
        ...
        public static string GetFooter(this ContentReference contentLink)
        {
            var loader = ServiceLocator.Current.GetInstance<IContentLoader>();
            var currentContent = loader.Get<StartPage>(ContentReference.StartPage);

            return currentContent.FooterText;
        }
    }
}